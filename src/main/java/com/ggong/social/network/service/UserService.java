package com.ggong.social.network.service;

import com.ggong.social.network.entity.DoubleIdObjectEntity;
import com.ggong.social.network.entity.IdObjectEntity;
import com.ggong.social.network.entity.UserEntity;
import com.ggong.social.network.repository.UserRepository;
...
public class UserService implements UserDetailsService {
    ...
    public ResponseObjectService findFollowing(String id) {
        ...
        if (optUser.isEmpty()) {
            ...
            List<String> followingIds = optUser.get().getFollowings();
    ...
    public ResponseObjectService saveUser(UserEntity inputUser) {
        ...
        if (optUser.isPresent()) {
            ...
            List<String> listFollowing = user.getFollowings();
            if (listFollowing == null) {
                listFollowing = new ArrayList<>();
            }
            listFollowing.add(user.getId());
            user.setFollowings(listFollowing);
    ...
    public ResponseObjectService followUser(DoubleIdObjectEntity doubleId) {
        ...
        if (optFollowedUser.isEmpty() || optFollower.isEmpty()) {
            ...
            List<String> followingList = follower.getFollowings();
